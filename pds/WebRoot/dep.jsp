	    ...
	    <div class="span_24">
	        ...
	        <div class="article" >
	            ...
	            <div class="detailedInfo">
	            	<label>作者：</label><s:property value="model.author==null?'admin':model.author" default="admin"/>
	            	<label>来源：</label><s:property value="model.dep" default="自律委"/>
	            	<label>日期：</label><s:date name="model.date" format="yyyy-MM-dd hh:mm:ss"/> 
	            </div>
	            <p class="content">
